...
import com.example.servicemusic.MyService.MyBinder;
...
public class MainActitivyPlay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Khởi tạo intent
        final Intent intent =
                new Intent(com.example.servicemusic.MainActitivyPlay.this,
                        MyService.class);
        ...
        imgNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isBound){
                    ...
                    Toast.makeText(com.example.servicemusic.MainActitivyPlay.this,
